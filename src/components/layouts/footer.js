                                    ...
                                    <div className="subcribe-form">
                                        <form id="subscribe">
                                            <input className="enteremail fl-wrap" name="email" id="subscribe-email" placeholder="Enter Your Email" spellCheck="false" type="text" />
                                                <button type="submit" id="subscribe-button" className="subscribe-button"><i className="fal fa-envelope"></i></button>
                                ...
                                <div className="footer-widget fl-wrap">
                                    ...
                                    <div className="footer-contacts-widget fl-wrap">
                                        ...
                                        <ul className="footer-contacts fl-wrap no-list-style">
                                            <li>
                                                <span><i className="fal fa-envelope"></i> Mail :</span>
                                                <a href="#" target="_blank">yourmail@domain.com</a>
                                            </li>
                                            <li>
                                                <span><i className="fal fa-map-marker"></i> Adress :</span>
                                                <a href="#" target="_blank">USA27TH Brooklyn NY</a></li>
                                            <li>
                                                <span><i className="fal fa-phone"></i> Phone :</span>
                                                <a href="#">+7(111)123456789</a></li>
                                        </ul>
                                        <div className="footer-social">
                                            ...
                                            <ul className="no-list-style">
                                                ...
                                                <li><a href="#" target="_blank"><i className="fab fa-whatsapp"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <div className="sub-footer  fl-wrap">
                    <div className="container">
                        ...
                        <div className="lang-wrap">
                            <div className="show-lang"><span><i className="fal fa-globe-europe"></i><strong>En</strong></span><i
                                className="fa fa-caret-down arrlan"></i></div>
