        ...
        return (
            <header className="main-header">
                ...
                <div className="header-search_btn show-search-button"><i
                    className="fal fa-search"></i><span>Search</span></div>
                ...
                <div className="cart-btn   show-header-modal" data-microtip-position="bottom" role="tooltip" aria-label="Your Wishlist">
                    ...
                    <span className="cart-counter green-bg"></span>
                </div>
                <div className="show-reg-form modal-open avatar-img" data-srcav={avatar7}>
                ...
                <div className="lang-wrap">
                    <div className="show-lang">
                        <span><i className="fal fa-globe-europe"></i><strong>En</strong></span>
                        <i className="fa fa-caret-down arrlan"></i></div>
                ...
                <div className="header-search_container header-search vis-search">
                    <div className="container small-container">
                        <div className="header-search-input-wrap fl-wrap">
                            ...
                            {/* header-search-input end */}
                            <button className="header-search-button green-bg"><i
                                className="far fa-search"></i> Search
                            </button>
                        </div>
                            ...
                            <ul className="no-list-style">
                                <li>
                                    <div className="widget-posts-img">
                                        <a href="listing-single.html"><img src={thumbnail1} alt="" /></a>
                                    </div>
                                    <div className="widget-posts-descr">
                                        <h4><a href="listing-single.html">Iconic Cafe</a></h4>
                                        <div className="geodir-category-location fl-wrap"><a href="#"><i
                                            className="fas fa-map-marker-alt"></i> 40 Journal Square Plaza, NJ, USA</a>
                                        </div>
                                        <div className="widget-posts-descr-link"><a href="listing.html">Restaurants </a>
                                ...
                                <li>
                                    ...
                                    <div className="widget-posts-descr">
                                        ...
                                        <div className="geodir-category-location fl-wrap"><a href="#"><i
                                            className="fas fa-map-marker-alt"></i> 70 Bright St New York, USA </a></div>
                                ...
                                <li>
                                    ...
                                    <div className="widget-posts-descr">
                                        ...
                                        <div className="geodir-category-location fl-wrap"><a href="#"><i
                                            className="fas fa-map-marker-alt"></i>75 Prince St, NY, USA</a></div>
                                ...
                                <li>
                                    ...
                                    <div className="widget-posts-descr">
                                        ...
                                        <div className="geodir-category-location fl-wrap"><a href="#"><i
                                            className="fas fa-map-marker-alt"></i> W 85th St, New York, USA</a></div>
