                                    ...
                                    <div className="geodir-category-footer fl-wrap">
                                        ...
                                        <div className="geodir-opt-list">
                                            <ul className="no-list-style">
                                                ...
                                                <li>
                                                    <div className="dynamic-gal gdop-list-link" data-dynamicPath="[{'src': 'images/all/1.jpg'},{'src': 'images/all/1.jpg'}, {'src': 'images/all/1.jpg'}]"><i className="fal fa-search-plus"></i><span className="geodir-opt-tooltip">Gallery</span></div>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="geodir-category-footer fl-wrap">
                                        ...
                                        <div className="geodir-opt-list">
                                            <ul className="no-list-style">
                                                ...
                                                <li>
                                                    <div className="dynamic-gal gdop-list-link" data-dynamicPath="[{'src': 'images/all/1.jpg'},{'src': 'images/all/1.jpg'}]"><i className="fal fa-search-plus"></i><span className="geodir-opt-tooltip">Gallery</span></div>
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="price-level geodir-category_price">
